// Generates runtime WebPs from asset-library/focus-room-source; see docs/plan/development/2d-scene-variant-workflow.md.
// Depth maps become smoothed lossless WebPs, and --depth-only skips every other scene asset.
import {createRequire} from 'node:module'
import {mkdir, mkdtemp, readdir, rename, rm, stat, writeFile} from 'node:fs/promises'
import path from 'node:path'

import {writeParallaxDepthWebp} from './depth-parallax-assets.mjs'
