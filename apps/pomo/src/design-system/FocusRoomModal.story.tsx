...
import {FocusRoomModal} from './FocusRoomModal'
...
const meta = {
  ...
  render: (props) => {
    ...
    return (
      <main class="grid min-h-screen place-items-center bg-[var(--focus-room-canvas)] p-6">
        <button
          class="rounded-full bg-[var(--focus-room-accent)] px-5 py-3 text-sm font-700 text-white"
          onClick={(event) => {
  ...
  title: 'Pomo/Components/Focus Room/FocusRoomModal',
} satisfies Meta<typeof FocusRoomModal>
