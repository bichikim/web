          ...
          {(credit) => (
            <li class={MUSIC_CREDIT_ITEM_CLASS}>
              ...
              <div class="min-w-0">
                ...
                <p class="mb-0 mt-0.5 text-sm leading-5 font-600 text-muted-foreground">
      ...
      <Show when={hasMoreCredits()}>
        <button
          ...
          class="flex min-h-8 cursor-pointer items-center justify-center gap-1.5 rounded-3 border-0
            bg-transparent px-3 text-sm leading-5 font-650 text-highlight outline-none transition-colors
