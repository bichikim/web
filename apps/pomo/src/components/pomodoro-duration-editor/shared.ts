...
export const CLASSES = {
  ...
  pomodoroPanelDurationField: cx(
    ...
    'text-modal-detail font-[650] leading-5',
  ),
  ...
  pomodoroPanelDurationHelp: cx(
    ...
    'text-modal-detail leading-5 text-center',
  ),
  pomodoroPanelDurationInput: cx(
    ...
    '[&_input]:outline-none [&_input]:text-modal-body',
  ),
  pomodoroPanelRoutine: cx(
    'pomo-pomodoro-panel__routine inline-flex items-center gap-1.5 m-[1rem_0_0] border-0',
    'bg-transparent p-1 text-muted-foreground cursor-pointer text-modal-detail leading-5',
