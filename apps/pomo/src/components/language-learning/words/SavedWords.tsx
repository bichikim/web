...
const WORD_FILTER_TAB_CLASS = cx(
  ...
  'border-0 bg-transparent px-2 text-sm leading-5 font-700 text-muted-foreground outline-none',
...
const WORD_FILTER_COUNT_CLASS = 'text-sm leading-5 font-650 tabular-nums opacity-70'
