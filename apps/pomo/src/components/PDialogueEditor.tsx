...
export default function PDialogueEditor(props: PDialogueEditorProps) {
  ...
  return (
    <main class="pomo-dialogue-editor">
      <header class="pomo-dialogue-editor__header">
        <div>
      ...
      <div class="pomo-dialogue-editor__layout">
        <section aria-labelledby="dialogue-content-title" class="pomo-dialogue-editor__panel">
          <div class="pomo-dialogue-editor__section-heading">
            <span>1</span>
            <div>
          ...
          <label class="pomo-dialogue-editor__field">
            <span class="pomo-dialogue-editor__field-label">
              대사
              <small>
        ...
        <section aria-labelledby="dialogue-voice-title" class="pomo-dialogue-editor__panel">
          <div class="pomo-dialogue-editor__section-heading">
            <span>2</span>
            <div>
          ...
          <div aria-live="polite" class="pomo-dialogue-editor__status" role="status">
          ...
          <div class="pomo-dialogue-editor__voice-actions">
            <button
              class="pomo-dialogue-editor__button pomo-dialogue-editor__button--primary"
          ...
          <Show when={editor.audioUrl()}>
            {(audioUrl) => (
              <div class="pomo-dialogue-editor__preview">
                <div>
        ...
        <section
          ...
          class={cx(
            'pomo-dialogue-editor__panel pomo-dialogue-editor__timeline-panel',
        ...
        >
          ...
          <Show
            ...
            fallback={
              <p class="pomo-dialogue-editor__empty">
      ...
      <footer class="pomo-dialogue-editor__footer">
