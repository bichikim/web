...
const CLASSES = {
  ...
  dialogueEditorBack: [
    ...
    'pomo-below-[48rem]:[justify-self:start]',
  ].join(' '),
  ...
  dialogueEditorFooter: [
    ...
    '[&_p]:text-[#a99d90] [&_p]:text-xs pomo-below-[48rem]:[&_p]:hidden',
  ].join(' '),
  ...
  dialogueEditorLayout: [
    ...
    'grid-cols-[repeat(2,_minmax(0,_1fr))] gap-4 pomo-below-[48rem]:grid-cols-[1fr]',
  ].join(' '),
  dialogueEditorMood: [
    ...
    '[&_span]:text-[#d8caba] [&_span]:leading-[1.35] pomo-below-[48rem]:[grid-column:2]',
  ].join(' '),
  dialogueEditorPanel: [
  ...
  dialogueEditorTimelinePanel:
    'pomo-dialogue-editor__timeline-panel col-span-full pomo-below-[48rem]:[grid-column:auto]',
