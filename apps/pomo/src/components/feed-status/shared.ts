...
export const CLASSES = {
  ...
  feedStatusAction: 'flex-none whitespace-nowrap',
  feedStatusActions: cx(
    'flex flex-none gap-[0.35rem]',
    'feed-status-compact:w-full feed-status-compact:[&_button]:flex-1',
  ),
  feedStatusCopy: cx(
    'grid min-w-0 flex-1 gap-[0.15rem] [&_strong]:overflow-hidden',
