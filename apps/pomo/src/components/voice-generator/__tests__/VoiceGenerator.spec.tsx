...
vi.mock('../Actions', () => ({VoiceActions: vi.fn()}))
vi.mock('../AudioChunks', () => ({AudioChunks: vi.fn()}))
vi.mock('../AudioResults', () => ({AudioResults: vi.fn()}))
vi.mock('../Fields', () => ({VoiceFields: vi.fn()}))
vi.mock('../Header', () => ({VoiceHeader: vi.fn()}))
vi.mock('../ModelPicker', () => ({ModelPicker: vi.fn()}))
