...
import {type LicenseData} from 'src/features/licenses'
import {NoticeGroupSection} from './GroupSection'
...
export const ThirdPartyNoticesDocument = (props: {readonly licenseData: LicenseData}) => {
  return (
