...
const CLASSES = {
  ...
  dialogueEditorBack: cx(
    ...
    '[border:0.0625rem_solid_rgb(255_255_255_/_12%)] rounded-full py-0 px-4 text-[#fffaf1] no-underline',
  ...
  dialogueEditorButton: cx(
    'pomo-dialogue-editor__button [&:focus-visible]:[outline:0.125rem_solid_#d6b585]',
    '[&:focus-visible]:[outline-offset:0.125rem] min-h-11 cursor-pointer border-0 rounded-full py-0',
  ...
  dialogueEditorButtonSecondary: cx(
    'pomo-dialogue-editor__button--secondary [border:0.0625rem_solid_rgb(255_255_255_/_14%)]',
  ...
  dialogueEditorField: cx(
    ...
    '[&_select]:[border:0.0625rem_solid_rgb(255_255_255_/_12%)] [&_select]:rounded-xl',
    ...
    '[&_textarea]:[border:0.0625rem_solid_rgb(255_255_255_/_12%)] [&_textarea]:rounded-xl',
    ...
    '[&_select:focus-visible]:[outline:0.125rem_solid_#d6b585]',
    '[&_select:focus-visible]:[outline-offset:0.125rem]',
    '[&_textarea:focus-visible]:[outline:0.125rem_solid_#d6b585]',
    '[&_textarea:focus-visible]:[outline-offset:0.125rem]',
  ),
  ...
  dialogueEditorFooter: cx(
    ...
    'gap-3 items-center [border:0.0625rem_solid_rgb(255_255_255_/_12%)] rounded-2xl',
  ...
  dialogueEditorPanel: cx(
    ...
    '[border:0.0625rem_solid_rgb(255_255_255_/_10%)] rounded-[1.25rem] bg-[rgb(38_31_25_/_88%)]',
