...
const CLASSES = {
  ...
  pomodoroPanelDurationEditor: [
    ...
    '[border:1px_solid_var(--pomo-border)] rounded-2xl bg-[rgb(4_4_3_/_24%)] p-3',
  ].join(' '),
  pomodoroPanelDurationField: [
    'pomo-pomodoro-panel__duration-field grid gap-1.5 text-[var(--pomo-text-muted)]',
  ...
  pomodoroPanelDurationHelp: [
    'pomo-pomodoro-panel__duration-help m-[0.5rem_0_0] text-[var(--pomo-text-muted)]',
  ...
  pomodoroPanelDurationInput: [
    ...
    '[border:1px_solid_var(--pomo-border)] rounded-[0.625rem] bg-[var(--pomo-glass)] py-0 px-2',
    'text-[var(--pomo-text-muted)] [&:focus-within]:border-[var(--pomo-brass)] [&_input]:w-full',
    '[&_input]:min-w-0 [&_input]:h-9 [&_input]:border-0 [&_input]:bg-transparent [&_input]:p-0',
    '[&_input]:text-[var(--pomo-text)] [&_input]:tabular-nums [&_input]:font-[750]',
    '[&_input]:outline-none',
  ].join(' '),
  pomodoroPanelRoutine: [
    'pomo-pomodoro-panel__routine inline-flex items-center gap-1.5 m-[1rem_0_0] border-0',
    'bg-transparent p-1 text-[var(--pomo-text-muted)] cursor-pointer text-[0.6875rem] leading-4',
    'text-center [&:hover]:text-[var(--pomo-text)] [&:focus-visible]:text-[var(--pomo-text)]',
  ].join(' '),
} as const
