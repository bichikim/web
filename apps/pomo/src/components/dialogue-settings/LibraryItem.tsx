...
const TEXT_CLASSES = cva(
  [
    'min-w-0 overflow-hidden m-0 text-foreground text-base font-[650] leading-[1.5]',
...
const CLASSES = {
  actions: cx(
    ...
    '[&_button]:text-sm [&_button]:leading-5 [&_button]:font-bold [&_button]:no-underline',
    ...
    '[&_a]:text-sm [&_a]:leading-5 [&_a]:font-bold [&_a]:no-underline',
  ...
  metadata: 'mt-1 block text-sm leading-5 text-muted-foreground',
