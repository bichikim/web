...
vi.mock('../AnalysisResult', () => ({TextMoodAnalysisResult: vi.fn()}))
vi.mock('../Evaluation', () => ({TextMoodEvaluation: vi.fn()}))
vi.mock('../InsufficientResult', () => ({TextMoodInsufficientResult: vi.fn()}))
