...
export const TextMoodEvaluation = () => (
  <footer class="mt-10 grid gap-4 border-t border-white/8 pt-6 2xl:grid-cols-[1fr_auto] 2xl:items-end">
    <div>
      ...
      <p class="mb-0 mt-1 max-w-2xl text-[0.6875rem] leading-5 text-#756a7d">
