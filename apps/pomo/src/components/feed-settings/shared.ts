export const CLASSES = {
  ...
  feedSettingsAddressCopy: cx(
    ...
    '[&_strong]:text-foreground [&_strong]:text-modal-body [&_strong]:font-[650]',
    '[&_strong]:whitespace-nowrap [&_small]:text-muted-foreground',
    '[&_small]:text-modal-detail [&_small]:leading-[1.4]',
  ),
  feedSettingsDelete: cx(
    'pomo-feed-settings__delete inline-flex min-h-control-md box-border',
    'cursor-pointer items-center justify-center gap-[0.35rem]',
    'border border-solid border-border rounded-control bg-transparent',
    'py-2 px-3 text-muted-foreground [font:inherit] text-modal-detail',
    'font-bold',
  ...
  feedSettingsListHeading: cx(
    ...
    '[&_h3]:text-modal-body [&_h3]:font-[750] flex items-center gap-[0.45rem]',
  ...
  feedSettingsRecommendationHeading: cx(
    ...
    '[&_h4]:text-modal-body [&_h4]:font-[750] [&_>_span]:text-muted-foreground',
    '[&_>_span]:text-modal-detail flex items-center gap-[0.45rem]',
  ),
  ...
  feedSettingsUrlField: cx(
    ...
    '[&_>_span]:text-modal-detail [&_>_span]:font-[650] [&_>_span]:leading-5 [&_input]:w-full',
    ...
    '[&_input]:[font:inherit] [&_input]:text-modal-body [&_input]:outline-none',
