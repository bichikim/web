...
export const flatSet: FlatData[] = Array.from<Omit<FlatData, 'fullName'>[]>({length: 14})
  .fill([
    {key: 2, name: 'A'},
    {key: 4, name: 'B'},
    {key: 5, name: 'C'},
...
export const sharpSet: SharpData[] = Array.from<Omit<SharpData, 'fullName'>[]>({length: 14})
  .fill([
    {key: 1, name: 'G#'},
