...
select-none outline-offset--3 cursor-pointer overflow-hidden min-w-max text-shadow-lg
text-shadow-color-[var(--var-semi-focus-bg)] c-[var(--var-text-color)] b-[var(--var-color)]
focus-visible:outline-[var(--var-focus-bg)] disabled:c-[var(--var-muted-color)] before:to-[var(--var-semi-focus-bg)]
`

const colorVariants = {
  aurora: `:uno:
   color-var-text-color=white var-color=transparent var-focus-bg=black var-muted-color=gray-400
   var-semi-muted-color=gray-300 var-semi-focus-bg=gray-200 var-aurora-color-1=#00c2ff
   var-aurora-color-2=#33ff8c var-aurora-color-3=#ffc640 var-aurora-color-4=#e54cff`,
  default: `:uno:
   color-var-text-color=black var-color=gray-100 var-focus-bg=black var-muted-color=gray-400
