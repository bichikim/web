...
const itemStyle = `:uno:
flex flex-col bg-opacity-90 b-1 b-white bg-white rd-1 backdrop-blur-sm p-0 max-w-50vm shadow-md items-start
`
    ...
    <Toast.Provider>
      <Toast.Body class={bodyStyle}>
        <Toast.Item class={itemStyle}>
          <div class="p-2 bg-white flex flex-col justify-start items-start">
