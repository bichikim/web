import {SplendidGrandPiano, type SplendidGrandPianoConfig} from 'smplr'
...
export const createSplendidGrandPiano = once(
  (options: SplendidGrandPianoOptions = {}): Accessor<SplendidGrandPiano | undefined> => {
