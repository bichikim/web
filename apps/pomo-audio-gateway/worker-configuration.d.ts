/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3094a0ade69c6fcf03819eda6b29057c)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
  PAID_AUDIO: R2Bucket
  ALLOWED_ORIGINS:
    | 'http://localhost:3000,http://localhost:3100,http://localhost:3200,http://localhost:3300,http://localhost:3400'
    | ''
  ...
  R2_OBJECT_PREFIX: '' | 'previews/local'
}
declare namespace Cloudflare {
  ...
  interface DevEnv {
    PAID_AUDIO: R2Bucket
    ALLOWED_ORIGINS: 'http://localhost:3000,http://localhost:3100,http://localhost:3200,http://localhost:3300,http://localhost:3400'
    ALLOWED_ORIGIN_SUFFIXES: '.vercel.app'
    R2_OBJECT_PREFIX: ''
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ALLOWED_ORIGINS' | 'ALLOWED_ORIGIN_SUFFIXES' | 'R2_OBJECT_PREFIX'>
  > {}
}
