...
3. DOM ownership: bind reactive values in JSX; use refs only for imperative capabilities and events. Via context, expose consumer needs, not raw nodes. See ./rules/dom-ref.md and ./rules/context-dom-exposure.md.
