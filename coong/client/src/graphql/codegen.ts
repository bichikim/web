...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    authenticateUserWithCryptoSignature(variables: AuthenticateUserWithCryptoSignatureMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AuthenticateUserWithCryptoSignatureMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AuthenticateUserWithCryptoSignatureMutation>(AuthenticateUserWithCryptoSignatureDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'authenticateUserWithCryptoSignature', 'mutation');
    },
    cryptoSignMessage(variables: CryptoSignMessageQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CryptoSignMessageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CryptoSignMessageQuery>(CryptoSignMessageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'cryptoSignMessage', 'query');
    }
  };
}
