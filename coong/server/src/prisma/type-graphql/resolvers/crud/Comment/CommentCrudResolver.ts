...
export class CommentCrudResolver {
  ...
  async createOneComment(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneCommentArgs,
  ): Promise<Comment> {
    const {_count} = transformFields(graphqlFields(info as any))
  ...
  async deleteOneComment(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneCommentArgs,
  ...
  async updateOneComment(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneCommentArgs,
  ): Promise<Comment | null> {
    const {_count} = transformFields(graphqlFields(info as any))
  ...
  async upsertOneComment(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneCommentArgs,
  ): Promise<Comment> {
    const {_count} = transformFields(graphqlFields(info as any))
