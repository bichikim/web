...
export class TagCrudResolver {
  ...
  async createOneTag(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneTagArgs,
  ): Promise<Tag> {
    const {_count} = transformFields(graphqlFields(info as any))
  ...
  async deleteOneTag(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneTagArgs,
  ): Promise<Tag | null> {
    const {_count} = transformFields(graphqlFields(info as any))
  ...
  async updateOneTag(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneTagArgs,
  ): Promise<Tag | null> {
    const {_count} = transformFields(graphqlFields(info as any))
  ...
  async upsertOneTag(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneTagArgs,
  ): Promise<Tag> {
    const {_count} = transformFields(graphqlFields(info as any))
