...
export interface JwtContext {
  sign: (payload: Record<string, any>, options?: Partial<SignOptions>, privateKey?: string)
    => Promise<string | undefined>
  verify: (payload: string, options?: VerifyOptions, privateKey?: string)
    => Promise<string | Jwt | JwtPayload | undefined>
}

const jwtSign = (payload: Record<string, any>, privateKey: string, options: Partial<SignOptions> = {}) => {
...
export const createJwt = (privateKey: string): JwtContext => {
  const sign = (payload: Record<string, any>, options?: Partial<SignOptions>, _privateKey?: string) => {
