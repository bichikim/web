...
const inputsInfo = {
  ...
  UserCreateInput: ["id", "email", "name", "password", "followers", "followerIDs", "following", "followingIDs", "likePosts", "likePostIDs", "posts", "roles"],
  ...
  UserCreateWithoutFollowingInput: ["id", "email", "name", "password", "followers", "followerIDs", "followingIDs", "likePosts", "likePostIDs", "posts", "roles"],
  UserCreateOrConnectWithoutFollowingInput: ["where", "create"],
  UserCreateWithoutFollowersInput: ["id", "email", "name", "password", "followerIDs", "following", "followingIDs", "likePosts", "likePostIDs", "posts", "roles"],
  ...
  UserCreateWithoutPostsInput: ["id", "email", "name", "password", "followers", "followerIDs", "following", "followingIDs", "likePosts", "likePostIDs", "roles"],
  UserCreateOrConnectWithoutPostsInput: ["where", "create"],
  UserCreateWithoutLikePostsInput: ["id", "email", "name", "password", "followers", "followerIDs", "following", "followingIDs", "likePostIDs", "posts", "roles"],
  UserCreateOrConnectWithoutLikePostsInput: ["where", "create"],
  UserUpsertWithoutPostsInput: ["update", "create"],
  UserUpdateWithoutPostsInput: ["email", "name", "password", "followers", "followerIDs", "following", "followingIDs", "likePosts", "likePostIDs", "roles"],
  ...
  UserUpdateWithoutFollowingInput: ["email", "name", "password", "followers", "followerIDs", "followingIDs", "likePosts", "likePostIDs", "posts", "roles"],
  UserUpdateWithoutFollowersInput: ["email", "name", "password", "followerIDs", "following", "followingIDs", "likePosts", "likePostIDs", "posts", "roles"],
  PostUpdateWithoutLikesInput: ["title", "author", "likeIDs"],
  PostUpdateWithoutAuthorInput: ["title", "likes", "likeIDs"],
  UserUpdateWithoutLikePostsInput: ["email", "name", "password", "followers", "followerIDs", "following", "followingIDs", "likePostIDs", "posts", "roles"]
};
