...
export type TailArray<A extends any[], S extends number> =
  S extends 0 ? (A extends [...infer TArgs] ? TArgs : never) :
    S extends 1 ? (A extends [any, ...infer TArgs] ? TArgs : never) :
      S extends 2 ? (A extends [any, any, ...infer TArgs] ? TArgs : never) :
        S extends 3 ? (A extends [any, any, any, ...infer TArgs] ? TArgs : never) :
          S extends 4 ? (A extends [any, any, any, any, ...infer TArgs] ? TArgs : never) :
            S extends 5 ? (A extends [any, any, any, any, any, ...infer TArgs] ? TArgs : never) :
...
export type GetArrayLength<T extends any[]> = T extends [] ? 0 :
  T extends [any] ? 1 :
    T extends [any, any] ? 2 :
      T extends [any, any, any] ? 3 :
        T extends [any, any, any, any] ? 4 :
          T extends [any, any, any, any, any] ? 5 :
            T extends [any, any, any, any, any, any] ? 6 : number
