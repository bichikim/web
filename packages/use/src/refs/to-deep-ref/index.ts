...
>(item: Ref<T>, path: [Key1]): WritableComputedRef<DeepGet<T, [Key1]>>
export function toDeepRef<
  T extends Record<string | symbol | number, any>,
  Key1 extends keyof T,
  Key2 extends keyof T[Key1],
>(item: Ref<T>, path: [Key1, Key2]): WritableComputedRef<DeepGet<T, [Key1, Key2]>>
export function toDeepRef<
  T extends Record<string | symbol | number, any>,
  Key1 extends keyof T,
  Key2 extends keyof T[Key1],
...
>(
  item: Ref<T>,
  path: [Key1, Key2, Key3],
): WritableComputedRef<DeepGet<T, [Key1, Key2, Key3]>>
export function toDeepRef<
  T extends Record<string | symbol | number, any>,
  Key1 extends keyof T,
  Key2 extends keyof T[Key1],
...
>(
  item: Ref<T>,
  path: [Key1, Key2, Key3],
): WritableComputedRef<DeepGet<T, [Key1, Key2, Key3, Key4]>>

// reactive
export function toDeepRef<
  T extends Record<string | symbol | number, any>,
  Key1 extends keyof T,
>(item: T, path: [Key1]): WritableComputedRef<DeepGet<T, [Key1]>>
export function toDeepRef<
  T extends Record<string | symbol | number, any>,
  Key1 extends keyof T,
  Key2 extends keyof T[Key1],
>(item: T, path: [Key1, Key2]): WritableComputedRef<DeepGet<T, [Key1, Key2]>>
export function toDeepRef<
  T extends Record<string | symbol | number, any>,
  Key1 extends keyof T,
  Key2 extends keyof T[Key1],
