...
describe('get-workspace-path', () => {
  it('should return root regex', () => {
    ...
    expect(testPath0.replace(new RegExp(regex, 'u'), '')).toBe('src/headless/form/__stories__/HForm.story.vue')
  })
  ...
  it('should return root', () => {
    ...
    expect(testPath1.replace(new RegExp(regex, 'u'), '')).toBe('src/headless/form/__stories__/HForm.story.vue')
  })
})
