...
export default defineConfig({
  ...
  rules: {
    ...
    // Oxfmt removes parentheses around conditional arrow bodies, so this rule cannot be satisfied after formatting.
    ...
    'project/forbidden-hooks': ['error', ['apps/pomo/src/utils/**/*']],
    'project/hooks-only': ['error', ['apps/pomo/src/hooks']],
    'project/sort-keys-fix': ['error', 'asc', {natural: true}],
    radix: 'error',
